...
const App = () => {
    ...
    return (
      ...
      >
        ...
        <div style={{ display: 'flex', gap: 12, marginBottom: 20, width: '100%' }}>
          <button className="btn-primary" style={{ width: '100%', background: '#ef4444' }} onClick={endRound}>
            Turu Bitir
          </button>
        </div>
      </motion.div>
  ...
  // ---------------------------------------------------------
  const renderResult = () => {
    const imposterNames = lastRound?.imposterNames ?? [];
    ...
    return (
      ...
      >
        <header style={{ marginBottom: 16, textAlign: 'center' }}>
          ...
          <h2 style={{ fontSize: '1.8rem' }}>Tur Sonu</h2>
          <p style={{ color: 'var(--text-muted)' }}>İşte cevap!</p>
        </header>
